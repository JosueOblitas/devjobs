<form class="md:w-1/2 flex flex-col space-y-5" wire:submit.prevent="editarVacante">
    <div>
    ...
    <div class="my-10">
        ...
        <x-text-input id="imagen" class="block mt-1 w-full" type="file" wire:model="imagen_nuevo"/>
        <div class="my-5 w-80">
            @if ($imagen)
